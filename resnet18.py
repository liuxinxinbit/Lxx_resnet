...
def resnet18_build(input_shape):
    ...
    residual = Conv2D(filters=64, kernel_size=(3, 3),
    ...
    output = Conv2D(filters=128, kernel_size=(3, 3),
                             strides=(2,2),
                              ...
                              kernel_regularizer=l2(1e-4))(output)
    output = _bn_relu(output)
    residual = Conv2D(filters=128, kernel_size=(3, 3),
                              strides=(1,1),
                              padding="same",
                             kernel_initializer="he_normal",
                             kernel_regularizer=l2(1e-4))(output)
    ...
    # block3
    output = _bn_relu(conv)
    output = Conv2D(filters=256, kernel_size=(3, 3),
                              strides=(2,2),
                              padding="same",
                              kernel_initializer="he_normal",
                              kernel_regularizer=l2(1e-4))(output)
    ...
    # block4
    output = _bn_relu(conv)
    output = Conv2D(filters=512, kernel_size=(3, 3),
                              strides=(2,2),
                              padding="same",
                              kernel_initializer="he_normal",
                             kernel_regularizer=l2(1e-4))(output)
